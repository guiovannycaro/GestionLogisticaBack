package com.gestion.rest.config.properties;
	...
	private Propiedad() {
		try {
			InputStream in = this.getClass()
					.getResourceAsStream("/com/gestion/rest/config//properties/version.properties");
			propVersion.load(in);
			in.close();

			in = this.getClass().getResourceAsStream("/com/gestion/rest/config/properties/param.properties");
			propGlobal.load(in);
			in.close();
