...
public class Usuarios {
	...
	@ApiModelProperty(value = "USU_ID", required = true, dataType = "Integer", example = "0000", position = 1)
    Integer USU_ID;
	@ApiModelProperty(value = "USU_NOMBRES", required = true, dataType = "String", example = "0000", position = 2)
	String USU_NOMBRES;
	@ApiModelProperty(value = "USU_DIRECCION", required = true, dataType = "String", example = "0000", position = 3)
	String USU_DIRECCION;
	@ApiModelProperty(value = "USU_TELEFONO", required = true, dataType = "String", example = "0000", position =4)
	String USU_TELEFONO;
	@ApiModelProperty(value = "USU_CORREO", required = true, dataType = "String", example = "0000", position = 5)
	String USU_CORREO;
	@ApiModelProperty(value = "USU_NUMDOCUMENTO", required = true, dataType = "String", example = "0000", position = 6)
	String USU_NUMDOCUMENTO;
	@ApiModelProperty(value = "USU_PASSWORD", required = true, dataType = "String", example = "0000", position = 7)
	String USU_PASSWORD;
	@ApiModelProperty(value = "USU_TDOC_ID", required = true, dataType = "Integer", example = "0000", position = 8)
	Integer USU_TDOC_ID;
